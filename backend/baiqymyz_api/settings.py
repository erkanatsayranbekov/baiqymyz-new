...
MOBIZON_API_BASE_URL = os.environ.get("MOBIZON_API_BASE_URL", "https://api.mobizon.kz")
...
PHONE_ONLY_AUTH_ENABLED = env_bool("PHONE_ONLY_AUTH_ENABLED", False)
...
ALLOW_GEO_BYPASS = DEBUG and env_bool("ALLOW_GEO_BYPASS", False)
